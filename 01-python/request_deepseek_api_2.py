...
from okCheck import ConservativeSafetyScanner
...
async def chat_with_deepseek(request: ChatRequest):
    ...
    try:
        ...
        scanner = ConservativeSafetyScanner()
        is_safe, message = scanner.check_input_safety(request.content)
...
##
        ...
        assistant_content =status + "_" + message
        # 记录模型回复内容
