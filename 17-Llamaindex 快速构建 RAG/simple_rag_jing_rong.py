...
#从指定目录读取文档，将数据加载到内存
documents = SimpleDirectoryReader("/Users/zhangpeng/code_bigmodel/jk-ai/00-data/jing_rong_csv").load_data()
# print(documents)
...
rsp = query_engine.query("A Priori Probabil 是我的数据，对我的数据进行纠错，返回正确的语句")
print(rsp)